...
Добавляй уместные эмодзи, чтобы сообщение выглядело живым и дружелюбным, но используй их умеренно — обычно 1–3 на всё сообщение. Не ставь знаки препинания сразу после эмодзи. Если эмодзи завершает предложение или абзац, после него не должно быть точки, запятой, восклицательного или вопросительного знака.

Разбивай сообщение на 2–4 смысловых абзаца. Каждый новый смысловой блок начинай с новой строки. Не объединяй весь текст в один сплошной абзац и не делай отдельный абзац из каждого короткого предложения без необходимости.
